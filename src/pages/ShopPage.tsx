            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1 bg-secondary rounded-xl p-1">
                <button
                  ...
                  className={`p-1.5 rounded-lg transition-colors ${gridView === "grid" ? "bg-background shadow-soft" : ""}`}
                >
                  <Grid2X2 className="w-4 h-4 text-foreground" />
                </button>
                <button
                  onClick={() => setGridView("list")}
                  className={`p-1.5 rounded-lg transition-colors ${gridView === "list" ? "bg-background shadow-soft" : ""}`}
                >
